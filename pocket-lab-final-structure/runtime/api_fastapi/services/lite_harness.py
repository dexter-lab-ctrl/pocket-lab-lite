...
_PROFILE_DATA: dict[str, dict[str, Any]] = {
    ...
    "security-assurance-runner": {
        ...
        "availability": "qualification-only",
        "capabilities": (
            "security.assurance.run", "security.assurance.read",
            "security.assurance.cancel", "security.assurance.passive",
            ...
            "security.assurance.policy_sync", "security.assurance.fault_control",
        ),
        "destructive_capabilities": (),
    },
    "recovery-qualifier": {
...
_ACTION_CAPABILITY: Mapping[str, str] = MappingProxyType({
    ...
    "security.assurance.run": "security.assurance.run",
    "security.assurance.read": "security.assurance.read",
    "security.assurance.report": "security.assurance.report",
