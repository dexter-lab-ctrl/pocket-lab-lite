...
configure_lite_runtime_limits(){
  ...
  export POCKETLAB_LITE_IDLE_GOVERNOR_ENABLED="${POCKETLAB_LITE_IDLE_GOVERNOR_ENABLED:-1}"
  export POCKETLAB_LITE_GC_TUNING_ENABLED="${POCKETLAB_LITE_GC_TUNING_ENABLED:-1}"
  export POCKETLAB_LITE_PROJECTION_IO_WORKERS="${POCKETLAB_LITE_PROJECTION_IO_WORKERS:-1}"
  export POCKETLAB_LITE_PROJECTION_CPU_WORKERS="${POCKETLAB_LITE_PROJECTION_CPU_WORKERS:-1}"
  export POCKETLAB_LITE_PROJECTION_IDLE_WAIT_SECONDS="${POCKETLAB_LITE_PROJECTION_IDLE_WAIT_SECONDS:-60}"
  export POCKETLAB_TELEMETRY_SAMPLE_SECONDS="${POCKETLAB_TELEMETRY_SAMPLE_SECONDS:-30}"
  export POCKETLAB_HEALTH_SAMPLE_SECONDS="${POCKETLAB_HEALTH_SAMPLE_SECONDS:-60}"
  export POCKETLAB_FLEET_SAMPLE_SECONDS="${POCKETLAB_FLEET_SAMPLE_SECONDS:-60}"
  export POCKETLAB_TELEMETRY_IDLE_SECONDS="${POCKETLAB_TELEMETRY_IDLE_SECONDS:-300}"
  export POCKETLAB_HEALTH_IDLE_SECONDS="${POCKETLAB_HEALTH_IDLE_SECONDS:-300}"
  export POCKETLAB_FLEET_IDLE_SECONDS="${POCKETLAB_FLEET_IDLE_SECONDS:-300}"
  export POCKETLAB_DEVICE_HEALTH_IDLE_SECONDS="${POCKETLAB_DEVICE_HEALTH_IDLE_SECONDS:-300}"
  export POCKETLAB_LIVE_STATUS_MAX_IDLE_SECONDS="${POCKETLAB_LIVE_STATUS_MAX_IDLE_SECONDS:-1800}"
  export POCKETLAB_WORKFLOW_PROCESS_OWNER="${POCKETLAB_WORKFLOW_PROCESS_OWNER:-worker}"
  export POCKETLAB_WORKFLOW_WRITER_QUEUE_SIZE="${POCKETLAB_WORKFLOW_WRITER_QUEUE_SIZE:-256}"
  export POCKETLAB_WORKFLOW_MAILBOX_CAPACITY="${POCKETLAB_WORKFLOW_MAILBOX_CAPACITY:-1024}"
  export POCKETLAB_WORKFLOW_BATCH_MAX_EVENTS="${POCKETLAB_WORKFLOW_BATCH_MAX_EVENTS:-24}"
  export POCKETLAB_WORKFLOW_BATCH_CPU_MS="${POCKETLAB_WORKFLOW_BATCH_CPU_MS:-35}"
  export POCKETLAB_WORKFLOW_BATCH_WALL_MS="${POCKETLAB_WORKFLOW_BATCH_WALL_MS:-100}"
  export POCKETLAB_WORKFLOW_SERIALIZED_BYTES_MAX="${POCKETLAB_WORKFLOW_SERIALIZED_BYTES_MAX:-65536}"
  export POCKETLAB_WORKFLOW_PROJECTION_ITEM_MAX="${POCKETLAB_WORKFLOW_PROJECTION_ITEM_MAX:-64}"
  export POCKETLAB_WORKFLOW_RECONCILE_MAX_ROWS="${POCKETLAB_WORKFLOW_RECONCILE_MAX_ROWS:-1000}"
  export POCKETLAB_WORKFLOW_RECONCILE_WORKFLOW_MAX="${POCKETLAB_WORKFLOW_RECONCILE_WORKFLOW_MAX:-256}"
  export POCKETLAB_WORKFLOW_UPDATES_PER_WORKFLOW_BATCH="${POCKETLAB_WORKFLOW_UPDATES_PER_WORKFLOW_BATCH:-8}"
  export POCKETLAB_WORKFLOW_SQLITE_DEADLINE_SECONDS="${POCKETLAB_WORKFLOW_SQLITE_DEADLINE_SECONDS:-2}"
  export POCKETLAB_WORKFLOW_RECYCLE_EVENT_COUNT="${POCKETLAB_WORKFLOW_RECYCLE_EVENT_COUNT:-10000}"
  export POCKETLAB_WORKFLOW_RECYCLE_BATCH_COUNT="${POCKETLAB_WORKFLOW_RECYCLE_BATCH_COUNT:-2000}"
  export POCKETLAB_WORKFLOW_RECYCLE_RSS_BYTES="${POCKETLAB_WORKFLOW_RECYCLE_RSS_BYTES:-268435456}"
...
start_pm2_daemons(){
  ...
  if is_lite_profile; then
    require_cmd opa
    [[ -f "$OPA_RUNTIME_START" ]] || die "OPA startup runtime script is missing: $OPA_RUNTIME_START"
    POCKETLAB_STATE_DIR="$POCKETLAB_STATE_DIR" \
    POCKETLAB_LITE_DB_PATH="$POCKETLAB_LITE_DB_PATH" \
