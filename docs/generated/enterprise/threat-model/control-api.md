...
<div class="pl-threat-boundary-summary" aria-label="Threat Model detail summary"><article><span>Type</span><strong>Canonical trust boundary</strong></article><article><span>Assets</span><strong>2</strong></article><article><span>Controls</span><strong>3</strong></article><article><span>Review</span><strong>human-review-required</strong></article></div>
...
| --- | --- | --- | --- |
| Spoofing | Source-derived candidate Spoofing threat affecting the Control API boundary. | OWASP Top 10 A07 Identification and Authentication Failures | CTRL-API-CONTROL, CTRL-HUMAN-SESSION-CSRF, CTRL-OPA-FAIL-CLOSED |
| Tampering | Source-derived candidate Tampering threat affecting the Control API boundary. | OWASP Top 10 A08 Software and Data Integrity Failures | CTRL-API-CONTROL, CTRL-HUMAN-SESSION-CSRF, CTRL-OPA-FAIL-CLOSED |
...
| Elevation of Privilege | Source-derived candidate Elevation of Privilege threat affecting the Control API boundary. | OWASP Top 10 A01 Broken Access Control | CTRL-API-CONTROL, CTRL-HUMAN-SESSION-CSRF, CTRL-OPA-FAIL-CLOSED |
