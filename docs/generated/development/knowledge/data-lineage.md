...
| `GET /api/lite/enterprise/rules/analysis` | ui:literules | — | unvalidated |
| `GET /api/lite/enterprise/rules/approvals` | ui:literules | — | unvalidated |
| `GET /api/lite/enterprise/rules/approvals/{approval_id}` | ui:literules | — | unvalidated |
| `GET /api/lite/enterprise/rules/decisions` | ui:literules | — | unvalidated |
| `GET /api/lite/enterprise/rules/exceptions` | ui:literules | — | unvalidated |
| `GET /api/lite/enterprise/rules/health` | ui:literules | — | unvalidated |
| `GET /api/lite/enterprise/rules/revisions` | ui:literules | — | unvalidated |
...
| `POST /api/lite/enterprise/rules/approvals/{approval_id}` | ui:literules | — | unvalidated |
| `POST /api/lite/enterprise/rules/exceptions` | ui:literules | — | unvalidated |
| `POST /api/lite/enterprise/rules/exceptions/{exception_id}/revoke` | ui:literules | — | unvalidated |
| `POST /api/lite/enterprise/rules/simulations` | ui:literules | — | unvalidated |
...
| `POST /api/lite/identity/step-up/options` | ui:liteidentity, ui:literules | — | unvalidated |
| `POST /api/lite/identity/step-up/verify` | ui:liteidentity, ui:literules | — | unvalidated |
