...
Promoted runtime baseline: **partial**; release: **lite-2026.08.06.2**. Promotion is explicit, sanitized, hash-bound, and ordinary generation never reads live captures.
...
| Apps | verified | partial | verified | observed | observed | observed | verified-with-mapped-presentation | verified |
...
| Backup & Restore | verified | verified | verified | observed | observed | observed | partial | ready-with-accepted-limitations |
