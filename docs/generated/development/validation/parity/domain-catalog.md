...
| Backup & Restore | verified | backup-state-file, backup-manifest, backup-receipt | /api/lite/recovery/backups, /api/lite/recovery/database, /api/lite/recovery/details, /api/lite/recovery/operations, /api/lite/recovery/summary | selectRecoverySummaryView, selectRecoveryScreenView | verified | observed | observed | observed | verified-with-mapped-presentation |
