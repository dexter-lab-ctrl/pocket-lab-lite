# Security Assurance Report — assurance-de72eb1604ed4b619c498bb2bc40e8b3
...
**What was tested:** the registered **adversarial** suite against **local_server_host_only** using the fixed harness and registered toolchain.

**Overall result:** **PASS**. The run recorded 6 scenario results and 0 sanitized normalized findings.
...
| Field | Value |
| --- | --- |
| Qualification ID | assurance-de72eb1604ed4b619c498bb2bc40e8b3 |
| Report ID | security-assurance-20260917T113934Z-66ed279c01-assurance-de72eb1604ed4b619c498bb2bc40e8b3 |
| Generation timestamp UTC | 2026-09-17T11:39:42.322303Z |
...
No normalized findings were recorded for this qualification.

## 10. STRIDE Matrix

| Threat | Scenarios | Passed | Failed | Partial | Blocked | Scenario IDs |
| --- | --- | --- | --- | --- | --- | --- |
| Denial of Service | 1 | 1 | 0 | 0 | 0 | runtime-readiness |
| Elevation of Privilege | 4 | 4 | 0 | 0 | 0 | harness-auth-boundary, caddy-proof-strip, source-boundaries, adversarial-negative-auth-probes |
| Information Disclosure | 3 | 3 | 0 | 0 | 0 | runtime-readiness, evidence-redaction, source-boundaries |
| Repudiation | 1 | 1 | 0 | 0 | 0 | evidence-redaction |
| Spoofing | 3 | 3 | 0 | 0 | 0 | harness-auth-boundary, caddy-proof-strip, adversarial-negative-auth-probes |
| Tampering | 5 | 5 | 0 | 0 | 0 | harness-auth-boundary, caddy-proof-strip, evidence-redaction, source-boundaries, adversarial-negative-auth-probes |
...
| A02 Cryptographic Failures | TESTED | 2 | 2 | EVIDENCE_PRESENT |
| A03 Injection | TESTED | 1 | 1 | EVIDENCE_PRESENT |
| A04 Insecure Design | HUMAN_REVIEW_REQUIRED | 0 | 0 | NOT_ASSESSED |
| A05 Security Misconfiguration | TESTED | 4 | 4 | EVIDENCE_PRESENT |
| A06 Vulnerable and Outdated Components | HUMAN_REVIEW_REQUIRED | 0 | 0 | NOT_ASSESSED |
| A07 Identification and Authentication Failures | TESTED | 3 | 3 | EVIDENCE_PRESENT |
| A08 Software and Data Integrity Failures | TESTED | 2 | 2 | EVIDENCE_PRESENT |
| A09 Security Logging and Monitoring Failures | TESTED | 1 | 1 | EVIDENCE_PRESENT |
...
| --- | --- |
| Duration ms | 29564 |
| Available memory | 2494943232 |
| Battery percent | 95.0 |
| Temperature C | 37.3 |
| Free storage | 136407433216 |
...
| --- | --- | --- | --- |
| CTRL-API-CONTROL | harness-auth-boundary, caddy-proof-strip, runtime-readiness, source-boundaries, adversarial-negative-auth-probes | AP-01, AP-02, AP-03, AP-04, AP-05, AP-07, AP-09, AP-10, AP-11, AP-12 | PASS |
| CTRL-EXECUTION-OWNERS | harness-auth-boundary, source-boundaries, adversarial-negative-auth-probes | AP-01, AP-02, AP-03, AP-04, AP-05, AP-07, AP-09, AP-10 | PASS |
| CTRL-EVIDENCE-SANITIZE | evidence-redaction, source-boundaries | AP-01, AP-02, AP-04, AP-05, AP-06, AP-07, AP-08 | PASS |
...
No open normalized findings were recorded. Incomplete or blocked scenario evidence still requires review above.

## 21. Retest Plan

Re-run the same suite after material security-control changes and compare against this qualification ID.
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-09-17T11:37:52Z | PASS | 0 | 0 | 0 | 100.0 | compatible |
