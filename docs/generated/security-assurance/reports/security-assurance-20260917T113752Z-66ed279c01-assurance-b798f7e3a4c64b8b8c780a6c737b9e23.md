# Security Assurance Report — assurance-b798f7e3a4c64b8b8c780a6c737b9e23
...
**What was tested:** the registered **standard** suite against **local_server_host_only** using the fixed harness and registered toolchain.

**Overall result:** **PASS**. The run recorded 11 scenario results and 1 sanitized normalized findings.
...
| Field | Value |
| --- | --- |
| Qualification ID | assurance-b798f7e3a4c64b8b8c780a6c737b9e23 |
| Report ID | security-assurance-20260917T113752Z-66ed279c01-assurance-b798f7e3a4c64b8b8c780a6c737b9e23 |
| Generation timestamp UTC | 2026-09-17T11:38:04.344427Z |
...
### assurance-b798f7e3a4c64b8b8c780a6c737b9e23-15deb392776f0f7b27d15fb1
...
| Retest guidance | Re-run scenario security-projection in suite standard after remediation. |

## 10. STRIDE Matrix

| Threat | Scenarios | Passed | Failed | Partial | Blocked | Scenario IDs |
| --- | --- | --- | --- | --- | --- | --- |
| Denial of Service | 4 | 4 | 0 | 0 | 0 | runtime-readiness, security-projection, policy-readiness, attack-path-inventory |
...
| Information Disclosure | 5 | 5 | 0 | 0 | 0 | runtime-readiness, evidence-redaction, security-projection, source-boundaries, attack-path-inventory |
| Repudiation | 5 | 5 | 0 | 0 | 0 | control-plane-ownership, evidence-redaction, security-projection, threat-model-integrity, attack-path-inventory |
| Spoofing | 4 | 4 | 0 | 0 | 0 | harness-default-off, harness-auth-boundary, caddy-proof-strip, attack-path-inventory |
| Tampering | 9 | 9 | 0 | 0 | 0 | harness-auth-boundary, caddy-proof-strip, control-plane-ownership, evidence-redaction, security-projection, policy-readiness, source-boundaries, threat-model-integrity, attack-path-inventory |
...
| A05 Security Misconfiguration | TESTED | 5 | 5 | EVIDENCE_PRESENT |
...
| A08 Software and Data Integrity Failures | TESTED | 7 | 7 | EVIDENCE_PRESENT |
| A09 Security Logging and Monitoring Failures | TESTED | 5 | 5 | EVIDENCE_PRESENT |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pocketlab-security | runtime-reported | UNAVAILABLE | RUNTIME_VERSION_NOT_CAPTURED | repository_revision | server_phone_worker | PASS | 0 | 298757 |
...
| bandit | 1.9.4 | NOT_RUN | NOT_OBSERVED | qualified_tool_receipt | dev_pc_static | NOT_RUN | 0 | UNAVAILABLE |
| gitleaks | 8.30.1 | NOT_RUN | NOT_OBSERVED | qualified_tool_receipt | dev_pc_static | NOT_RUN | 0 | UNAVAILABLE |
| pip-audit | 2.10.1 | NOT_RUN | NOT_OBSERVED | qualified_tool_receipt | dev_pc_static | NOT_RUN | 0 | UNAVAILABLE |
| npm-audit | 11.13.0 | NOT_RUN | NOT_OBSERVED | qualified_tool_receipt | dev_pc_static | NOT_RUN | 0 | UNAVAILABLE |
| opa | runtime-reported | UNAVAILABLE | RUNTIME_VERSION_NOT_CAPTURED | policy_status | server_phone_worker | PASS | 0 | UNAVAILABLE |
| schemathesis | 4.23.0 | NOT_RUN | NOT_OBSERVED | qualified_tool_receipt | dev_pc_live_runtime | NOT_RUN | 0 | UNAVAILABLE |
| cosign | 3.1.3 | NOT_RUN | NOT_OBSERVED | qualified_tool_receipt | dev_pc_static | NOT_RUN | 0 | UNAVAILABLE |
| semgrep | 1.172.0 | NOT_RUN | NOT_OBSERVED | qualified_tool_receipt | dev_pc_static | NOT_RUN | 0 | UNAVAILABLE |
| osv-scanner | 2.5.0 | NOT_RUN | NOT_OBSERVED | qualified_tool_receipt | dev_pc_static | NOT_RUN | 0 | UNAVAILABLE |
| testssl.sh | 3.2.2 | NOT_RUN | NOT_OBSERVED | qualified_tool_receipt | dev_pc_live_runtime | NOT_RUN | 0 | UNAVAILABLE |
| nuclei | 3.8.0 | NOT_RUN | NOT_OBSERVED | qualified_tool_receipt | dev_pc_live_runtime | NOT_RUN | 0 | UNAVAILABLE |
| nmap | 7.98 | NOT_RUN | NOT_OBSERVED | qualified_tool_receipt | dev_pc_live_runtime | NOT_RUN | 0 | UNAVAILABLE |
...
| --- | --- |
| Duration ms | 347344 |
| Available memory | 2476310528 |
| Battery percent | 95.0 |
| Temperature C | 37.3 |
| Free storage | 136392736768 |
...
| CTRL-EVIDENCE-SANITIZE | harness-default-off, evidence-redaction, security-projection, source-boundaries, threat-model-integrity, attack-path-inventory | AP-01, AP-02, AP-03, AP-04, AP-05, AP-06, AP-07, AP-08, AP-09, AP-10, AP-11, AP-12, AP-13, AP-14 | PASS |
| CTRL-EXECUTION-OWNERS | harness-auth-boundary, control-plane-ownership, security-projection, source-boundaries | AP-01, AP-02, AP-03, AP-04, AP-05, AP-06, AP-07, AP-08, AP-09, AP-10 | PASS |
...
| --- | --- | --- |
| low | assurance-b798f7e3a4c64b8b8c780a6c737b9e23-15deb392776f0f7b27d15fb1 | Keep this server-side config locked down, exclude it from frontend assets and normal evidence, and rotate it during planned maintenance if exposure is suspected. |

## 21. Retest Plan

| Finding | Scenario | Suite | Expected fixed invariant |
| --- | --- | --- | --- |
| assurance-b798f7e3a4c64b8b8c780a6c737b9e23-15deb392776f0f7b27d15fb1 | security-projection | standard | The registered scenario reaches its expected invariant without the finding recurring. |
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-09-17T11:30:42Z | PASS | 0 | 0 | 0 | 100.0 | compatible |
