...
description: "Lite-friendly workflow guide generated from verified journey metadata."
generated: true
...
| Release and update flow | release | source-derived |
| Tailscale and remote access readiness | devices | source-derived |
| Remove Old Device | devices | source-derived |
| Restart Agent | devices | source-derived |
...
| Security scan | security | source-derived |
| Pocket Lab Lite startup | platform | source-derived |
