...
def hub(m):
    ...
    cards=[('Security Assurance Reports','reports/','Per-qualification sanitized reports with exact runtime SHA and bounded verdicts.'),('How the Security Model and Assurance Evidence Fit Together','model-and-evidence/','Threat model, assurance definition, and exact qualification evidence.'),('Scenario Walkthroughs','scenario-walkthroughs/','Trace AP-01, AP-02, AP-06, and AP-11 from model to evidence.'),('STRIDE: Model vs Qualification Evidence','stride-evidence/','STRIDE categories beside executed evidence; no security score.'),('OWASP: Model vs Qualification Evidence','owasp-evidence/','Secondary OWASP lens with explicit uncertainty.'),('Model ↔ Assurance Evidence','model-assurance-evidence/','AP, control, scenario, suite, finding, SHA, and human-review joins.'),('Scenario → Model','scenario-model/','Registered scenarios and exact model relationships.'),('How to Read Security Documentation','how-to-read/','Question-to-destination guide and truth-boundary vocabulary.'),('Threat Model','../../threat-model/','Canonical threats, paths, controls, assets, and boundaries.'),('Security Atlas','../../threat-model/catalog/','Static model catalog; modeled, not live traffic.'),('Trust Boundaries','../../../production/architecture/network-boundaries/','Architecture-owned trust boundaries.'),('Security Controls','../../reference/security-controls/','Canonical control posture and implementation references.'),('Assets & Guardrails','../../threat-model/assets-guardrails/','Protected assets and model guardrails.'),('Evidence & Provenance','../../threat-model/evidence/','Evidence provenance and residual uncertainty.'),('Supply Chain','../../reference/supply-chain/','Normalized supply-chain evidence.'),('Human Review','../../threat-model/evidence/','Residual risk and human-governed assurance decisions.')]
