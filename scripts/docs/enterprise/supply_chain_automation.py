...
def capture(
    ...
    *,
    ...
    try:
        ...
        run_capture_step(run_dir, manifest, resume=resume, selected=selected, step_id="trivy-source", tool="trivy", argv=["fs", "--format", "json", "--scanners", "vuln,misconfig,secret,license", "--skip-dirs", ".git", "--skip-dirs", "node_modules", "--skip-dirs", ".venv", "--skip-dirs", "docs/generated", "--skip-dirs", "contracts/generated", "."], stdout_output=raw / "trivy-source.json")
