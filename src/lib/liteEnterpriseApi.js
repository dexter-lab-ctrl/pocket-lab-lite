...
export const liteEnterpriseApi = {
  ...
  regeneratePersonInvite: (humanId) => post(`/api/lite/enterprise/identity/people/${encodeURIComponent(humanId || '')}/invite`, {}),
  ...
  consumeEnrollment: (claim) => post('/api/lite/enterprise/identity/enrollment/consume', { claim }),
  enrollmentStatus: () => get('/api/lite/enterprise/identity/enrollment/status'),
  enrollmentPasskeyOptions: () => post('/api/lite/enterprise/identity/enrollment/passkey/options', {}),
  verifyEnrollmentPasskey: (payload) => post('/api/lite/enterprise/identity/enrollment/passkey/verify', payload),
