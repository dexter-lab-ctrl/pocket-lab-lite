...
export const liteApi = {
  ...
  backupAppToStorage: (appId = 'photoprism', payload = {}) => postJson(`/api/lite/recovery/apps/${encodeURIComponent(appId)}/backup-to-target`, payload),
  recoveryApp: (appId = 'photoprism') => readJson(`/api/lite/recovery/apps/${encodeURIComponent(appId)}`),
  backupApp: (appId = 'photoprism', payload = {}) => postJson(`/api/lite/recovery/apps/${encodeURIComponent(appId)}/backup`, payload),
  previewAppRestore: (appId = 'photoprism', payload = {}) => postJson(`/api/lite/recovery/apps/${encodeURIComponent(appId)}/restore/preview`, payload),
