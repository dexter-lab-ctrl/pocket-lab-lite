...
export const liteQueryKeys = {
  ...
  telemetryThresholds: () => ['lite', 'system', 'telemetry-thresholds'],
  storagePressure: () => ['lite', 'system', 'storage-pressure'],
  sqliteHealth: () => ['lite', 'system', 'sqlite-health'],
  ...
  deviceHealthHistory: (deviceId = '', limit = 20, cursor = '') => ['lite', 'fleet', 'device-health-history', String(deviceId || ''), Number(limit || 20), String(cursor || 'first')],
  fleetHealthSummary: () => ['lite', 'fleet', 'health-summary'],
  ...
  hotPathDiagnostics: () => ['lite', 'diagnostics', 'hot-path'],
...
export const liteQueryPaths = {
  ...
  telemetryThresholds: '/api/lite/system/telemetry-thresholds',
  storagePressure: '/api/lite/system/storage-pressure',
  sqliteHealth: '/api/lite/system/sqlite-health',
  ...
  deviceHealthHistory: (deviceId = '', limit = 20, cursor = '') => `/api/lite/devices/${encodeURIComponent(deviceId || '')}/health/history?limit=${encodeURIComponent(limit || 20)}${cursor ? `&cursor=${encodeURIComponent(cursor)}` : ''}`,
  fleetHealthSummary: '/api/lite/fleet/health-summary',
  ...
  hotPathDiagnostics: '/api/lite/diagnostics/runtime',
